...
export default function RegisterPage() {
  ...
  useEffect(() => {
    ...
    // Load Google Identity Services SDK secara native
          ...
          ;(window as any).google.accounts.id.initialize({
            ...
            callback: (response: any) => {
              try {
                ...
                console.error('Google One Tap parse error:', e)
              }
            }
          })

          const btnContainer = document.getElementById('googleNativeBtnRegister')
          if (btnContainer) {
  ...
  const executeGoogleAuth = async (targetEmail: string, targetName?: string) => {
    ...
    try {
      ...
      toast.success(`Pendaftaran Google Berhasil! 🎉`, `Selamat datang, ${name}.`)
      setTimeout(() => {
      ...
      toast.error('Google Register Gagal', err.response?.data?.detail || 'Gagal pendaftaran Google.')
    } finally {
      setLoading(false)
    }
  }
    ...
    >
      ...
      >
        ...
        >
          ...
          <div id="googleNativeBtnRegister" style={{ display: 'none' }}></div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: 12, color: '#64748b', marginBottom: 16 }}>
              Daftar akun <strong>STOXAREA</strong> menggunakan akun Google Anda.
            </p>
